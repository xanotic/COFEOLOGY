...
public class Tracker {
    ...
    public static void viewExpense(String[] dates, String[] categories, double[] amounts, int counter) {
        ExpenseTrackerApp.clearScreen();
        if (counter == 0) {
    ...
    public static void viewIncome(String[] dates, String[] categories, double[] amounts, int counter) {
        ExpenseTrackerApp.clearScreen();
        if (counter == 0) {
            ...
            for (int j = 0; j < counter; j++) {
                // Ensure the amount is printed as positive without any sign
                System.out.printf("%-20s%-20s$%-20.2f\n", dates[j], categories[j], Math.abs(amounts[j]));
                System.out.println("---------------------------------------------------------------");
            }
        }
